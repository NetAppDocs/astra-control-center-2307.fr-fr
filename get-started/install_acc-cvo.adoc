...
ASTRA Trident 22.10 ou version ultérieure est installé et configuré et NetApp ONTAP version 9.8 ou version ultérieure en tant que système back-end de stockage [[aws-registry]]
...
| Astra Trident (installé dans le cadre de la découverte du cluster Kubernetes dans NetApp BlueXP, anciennement Cloud Manager)  a| 
ASTRA Trident 22.10 ou version ultérieure est installé et configuré et NetApp ONTAP version 9.8 ou version ultérieure en tant que système back-end de stockage [[gcp-registry]]
...
ASTRA Trident 22.10 ou version ultérieure installée et configurée et NetApp ONTAP version 9.8 ou ultérieure seront utilisés en tant que système back-end de stockage [[Azure-registry]]
